...
// PYP & Mock Test Series Platform
$route['test-series'] = "test_series/index";
$route['test-series/exam/(:any)'] = "test_series/exam/$1";
$route['test-series/instructions/(:num)'] = "test_series/instructions/$1";
$route['test-series/start/(:num)'] = "test_series/start/$1";
$route['test-series/engine/(:num)'] = "test_series/engine/$1";
$route['test-series/save-response'] = "test_series/save_response";
$route['test-series/submit-exam'] = "test_series/submit_exam";
$route['test-series/scorecard/(:num)'] = "test_series/scorecard/$1";
$route['test-series/solutions/(:num)'] = "test_series/solutions/$1";
$route['pass'] = "test_series/pass";
$route['pass/activate-trial/(:num)'] = "test_series/activate_trial/$1";
