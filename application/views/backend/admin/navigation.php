...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<li class="side-nav-item <?php if (strpos($page_name, 'pyp_') !== false) echo 'active'; ?>">
			<a href="javascript: void(0);" class="side-nav-link <?php if (strpos($page_name, 'pyp_') !== false) : ?> active <?php endif; ?>">
				<i class="dripicons-document-edit"></i>
				<span> <?php echo get_phrase('Test Series (PYP)'); ?> </span>
				<span class="menu-arrow"></span>
			</a>
			<ul class="side-nav-second-level" aria-expanded="false">
				<li class="<?php if ($page_name == 'pyp_papers') echo 'active'; ?>">
					<a href="<?php echo site_url('admin/pyp_papers'); ?>"><?php echo get_phrase('all_test_papers'); ?></a>
				</li>
				<li class="<?php if ($page_name == 'pyp_paper_add') echo 'active'; ?>">
					<a href="<?php echo site_url('admin/pyp_paper_form/add'); ?>"><?php echo get_phrase('create_new_paper'); ?></a>
				</li>
				<li class="<?php if ($page_name == 'pyp_questions' || $page_name == 'pyp_question_add') echo 'active'; ?>">
					<a href="<?php echo site_url('admin/pyp_questions/1'); ?>"><?php echo get_phrase('question_bank'); ?></a>
				</li>
				<li class="<?php if ($page_name == 'pyp_import') echo 'active'; ?>">
					<a href="<?php echo site_url('admin/pyp_import/1'); ?>"><?php echo get_phrase('bulk_importer'); ?></a>
				</li>
			</ul>
		</li>
